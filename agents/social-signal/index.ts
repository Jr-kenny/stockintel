...
const PORT = Number(process.env["CONNECTOR_PORT"] ?? 8792);
const GDELT_ENABLED = (process.env["SIGNALS_GDELT"] ?? "on").toLowerCase() !== "off";

const NAME = "social-signal — Social signals — public statem";
const SPECIALTY =
  "Social signals — public statements, hiring and activity indicating commercial intent";
 ...
 *
 * social-signal: Intent before announcement: hiring surges, developer chatter, technical community reaction.
 */
const BEAT = {
  googleNews: true,
  gdelt: true,
