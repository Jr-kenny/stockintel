 ...
 *
 * prime-signals: Wide global sweep for change-of-state events. Deliberately unrestricted, the widest net on the grid.
 */
const BEAT = {
  googleNews: true,
  gdelt: true,
  ...
  angles: [
    "announces expansion investment",
    "breaks ground opens facility",
  ] as string[],
};
