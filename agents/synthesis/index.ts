...
const PORT = Number(process.env["CONNECTOR_PORT"] ?? 8799);
 ...
 *
 * synthesis: Analytical and second-order coverage — the pieces that already connect two events, useful raw material for the orchestrator's own connection pass.
 */
const BEAT = {
  googleNews: true,
  gdelt: false,
  ...
  angles: [
    "analysis implications means for",
