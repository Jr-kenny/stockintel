...
const BUILDINGS: Building[] = [
  { ticker: "NVDA", blurb: "GPUs and AI infra", thesis: "Hyperscale buildouts land here first. Watch capex guides, then price.", x: 330, y: 330, w: 80, d: 80, h: 260, c: "#a8cfd0", cols: 4, rows: 8 },
  { ticker: "MU", blurb: "Memory chips", thesis: "Every GPU rack needs memory. Buildouts pull MU second.", x: 150, y: 330, w: 60, d: 60, h: 60, c: "#c3ccb0", cols: 3, rows: 3 },
  { ticker: "DELL", blurb: "AI servers", thesis: "Racks ship through server vendors. Orders confirm the chain.", x: 150, y: 250, w: 60, d: 60, h: 90, c: "#b9c9d8", cols: 3, rows: 4 },
  { ticker: "AVGO", blurb: "Networking chips", thesis: "Fabric ties the cluster together. Networking rides each expansion.", x: 30, y: 130, w: 80, d: 70, h: 80, c: "#b9d4c2", cols: 4, rows: 4 },
  { ticker: "MSFT", blurb: "Cloud and AI", thesis: "Capex guidance starts here. A raise moves the whole block.", x: 320, y: 20, w: 70, d: 120, h: 170, c: "#c9bfe0", cols: 4, rows: 7 },
  { ticker: "AMZN", blurb: "Cloud and retail", thesis: "Second cloud signal. Confirms demand is broad, not one buyer.", x: 410, y: 30, w: 90, d: 80, h: 130, c: "#9fb8d8", cols: 5, rows: 6 },
  { ticker: "AAPL", blurb: "Devices and services", thesis: "Edge demand follows data center spend with a lag.", x: 20, y: 20, w: 90, d: 90, h: 200, c: "#a9b7c9", cols: 5, rows: 8 },
  { ticker: "META", blurb: "Ads and AI", thesis: "Open compute buyer. Build pace shows in capex calls.", x: 125, y: 30, w: 75, d: 70, h: 110, c: "#e9c1a0", cols: 4, rows: 5 },
  { ticker: "TSLA", blurb: "EVs and robots", thesis: "Power and factory signals cross over from autos.", x: 30, y: 420, w: 80, d: 90, h: 150, c: "#dcb3b8", cols: 4, rows: 6 },
  { ticker: "GOOGL", blurb: "Search and cloud", thesis: "TPU versus GPU mix shifts exposure at the margin.", x: 340, y: 430, w: 160, d: 80, h: 100, c: "#cfc5d6", cols: 8, rows: 4 },
  { ticker: "JPM", blurb: "Banking", thesis: "Financing conditions set the pace of new builds.", x: 20, y: 320, w: 120, d: 80, h: 90, c: "#e8dcc4", cols: 6, rows: 4 },
  { ticker: "PLTR", blurb: "Data and AI", thesis: "Deployment layer. Contracts confirm demand is real.", x: 430, y: 340, w: 80, d: 60, h: 45, c: "#ecd9a1", cols: 4, rows: 2 },
];
        ...
        <div className="city-copy">
          ...
          {active && (
            <div className="city-thesis" aria-live="polite">
              ...
              <Link to="/app" className="city-thesis-link">Watch {active.ticker} in the app</Link>
            </div>
          )}
        </div>

        <div className="city-stage" role="img" aria-label="Isometric market city, buildings are watched tickers">
          <div className="city-scene">
            <div className="city-ground">
              ...
              <div className="city-neon" aria-hidden>bStocks · 24/7</div>
            </div>
          </div>
        </div>
      </section>
